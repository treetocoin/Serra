/**
 * TankLevelChart Component
 *
 * Single-line tank level chart using Recharts.
 * Adapted from TemperatureChart with tank level-specific styling.
 * Handles multiple units: cm, L, or %
 *
 * @feature 005-lavoriamo-alla-pagina T019
...
export interface TankLevelChartProps {
    ...
    <ResponsiveContainer width="100%" height={300}>
      ...
      >
        ...
        <Tooltip
          ...
          formatter={(value: number) => [formatValue(value), 'Livello Serbatoio']}
          contentStyle={{
...
export function TankLevelChartSkeleton() {
  return (
    <div
