 ...
 *
 * Temperature chart with support for both single and comparison modes.
 * Phase 3 (T016): Basic single sensor visualization.
 * Phase 4 (T025): Extended for comparison overlay (sopra vs sotto).
 *
 * @feature 005-lavoriamo-alla-pagina T016, T025
 * @see ../../../specs/005-lavoriamo-alla-pagina/research.md Section 3
 * @see ../../../specs/005-lavoriamo-alla-pagina/quickstart.md Section 4.2
 */
...
export function TemperatureChart({
  ...
  // Determine whether to show dots based on data density
        ...
        {isComparison ? (
          <>
            <Line
              ...
              dot={showDots}
              connectNulls={false}
              name={chartData[0]?.primaryLabel || 'Temperatura Sopra'}
            />
            <Line
              type="monotone"
              ...
              dot={showDots}
              connectNulls={false}
              name={chartData[0]?.secondaryLabel || 'Temperatura Sotto'}
            />
          </>
        ) : (
          <Line
